...
function poseidon_customize_preview_js() {
	wp_enqueue_script( 'poseidon-customize-preview', get_template_directory_uri() . '/assets/js/customize-preview.js', array( 'customize-preview' ), '20170806', true );
}
...
function poseidon_customizer_controls_js() {
	wp_enqueue_script( 'poseidon-customizer-controls', get_template_directory_uri() . '/assets/js/customizer-controls.js', array(), '20170806', true );
}
...
function poseidon_customize_preview_css() {
	wp_enqueue_style( 'poseidon-customizer-css', get_template_directory_uri() . '/assets/css/customizer.css', array(), '20170806' );
}
