<?php
    ...
    if( $xml === false ) {
        ...
        foreach( $xml->entry as $feed ) {
            ...
            // $strOutput .=  "<div class='thumbnail' style='height: " . $thumb_size . "px;  margin:20px;' data-index=\"".$intCounter."\">\n";
            //$strOutput .=  "<div class='thumbnail' style='heightxxx: " . $thumb_size . "px;  marginxxx:20px;' data-index=\"".$intCounter."\">\n";
