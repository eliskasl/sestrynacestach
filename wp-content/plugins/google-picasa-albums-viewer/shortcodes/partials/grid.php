<?php
    ...
    if( $fx===NULL ){
        ...
        $strOutput .=  "<style>.grid-item.albums{ width: " . $thumb_size . "px !important; height: " . $thumb_size . "px !important; }</style>\n";
    }
            ...
            if( !in_array( $title, $hide_albums ) ) {
                ...
                if( $fx === NULL ){
                    ...
                    if ( get_option( 'permalink_structure' ) ) { 
                        ...
                        $strOutput .=  "<a href='" . $results_page . "?cws_album=$id[0]&cws_album_title=$title'><img alt='$title' src='$a[0]' title='$title' />\n";
                    ...
                    if( $fx === NULL ) {
                        ...
                        if ( $show_title ) {
                            if ( get_option( 'permalink_structure' ) ) { 
                                $strOutput .=  "<li class='title'><a href='" .$results_page . "?cws_album=$id[0]&cws_album_title=$title'>$title</a></li>\n";
                            } else {
                                $strOutput .=  "<li class='title'><a href='" .$results_page . "&cws_album=$id[0]&cws_album_title=$title'>$title</a></li>\n";
                            }
                        }
