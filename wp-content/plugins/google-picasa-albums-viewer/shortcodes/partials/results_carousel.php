<?php
    ...
    if( $xml === false ) {
        ...
        foreach( $xml->entry as $feed ) {
            ...
            $strOutput .= "<a itemprop=\"contentUrl\" data-size=\"". $content[0]['width'] ."x".$content[0]['height']."\" data-index=\"".$intCounter."\" href='" . $b['src'] . "' data-largesrc='" . $b['src'] . "' data-title='' data-description=''><img src='" . $a['url'] . "' alt='' />\n";
