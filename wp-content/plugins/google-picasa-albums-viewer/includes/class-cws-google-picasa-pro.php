...
// test ik
        //////$this->loader->add_action( 'admin_init', $plugin_admin, 'cws_gpp_ignore_upgrade' ); 
        //////$this->loader->add_action( 'admin_init', $plugin_admin, 'cws_gpp_admin_notices_styles' );  
//$this->loader->add_action( 'admin_init', $plugin_admin, 'myFunction' ); 

        // $this->loader->add_action( 'wp_loaded', $plugin_admin, 'getCurrentUser' );
        // comment out below to see if it stops error log...
        // $this->loader->add_action( 'wp_loaded', $plugin_admin, 'getCurrentUser' );
	}
